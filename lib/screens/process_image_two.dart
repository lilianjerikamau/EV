                                  ...
                                  CheckboxListTile(
                                    ...
                                    onChanged: (bool? value) {
                                      setState(() {
                                        ...
                                        print('isfirstchecked');
                                        print(isFirstChecked = true);
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              ...
                              if (mileage != null) {
                                if (form.validate()) {
                                  dial.show();
                                  if (widget.issoda != true) {
                                    print('You are submitting sodoooooo');
                                    ...
                                    Navigator.pushReplacement(context,
                                      ...
                                      return OdometerPicture(
                                        ...
                                        isphev: false, obcem: null, obfcm: null,
                                      );
                                    }));
                                    // SodoService sodoservice =
                                    //     SodoService(context);
                                ...
                                ScaffoldMessenger.of(context)
                                    .showSnackBar(SnackBar(
                                  behavior: SnackBarBehavior.floating,
                                  content: Text('Please select mileage'),
                                  duration: Duration(seconds: 3),
                                ));
                              }
                            },
