...
class PHEV extends StatefulWidget {
  final imagePath;
  final vehicleId;
  final issoda;
  final ev_technology;
  ...
  @override
  State<PHEV> createState() => _PHEVState();
}

class _PHEVState extends State<PHEV> {
  int id = 0;
  String token = '',
      fuel_units = '',
      distance_units = '',
  ...
  SharedPreferences  prefs = await SharedPreferences.getInstance();
    //Return String
    setState(() {
      stringValue = prefs.getString('obcem');
      print('stringValue');
      print(stringValue);
    });
    return stringValue;
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Row(
                                  ...
                                  children: [
                                    Expanded(
                                      child:  widget.ev_technology.contains("") || widget.ev_technology.contains("FCEV")? Text(
                                        'Select OBECM',
                                        style: TextStyle(color: Color(0xFF75A843)),
                                      ):Text(
                                          'Select OBECM ',
