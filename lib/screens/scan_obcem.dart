...
class OBCEM extends StatefulWidget {
  final imagePath;
  final vehicleId;
  final issoda;
  final ev_technology;
  ...
  @override
  State<OBCEM> createState() => _OBCEMState();
}

class _OBCEMState extends State<OBCEM> {
  int id = 0;
  String token = '',
      fuel_units = '',
      distance_units = '',
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                        ...
                                        children: [
                                          Expanded(
                                            child:  widget.ev_technology.contains("PHEV") || widget.ev_technology.contains("FCEV")? Text(
                                              'Select OBECM',
                                              style: TextStyle(color: Color(0xFF75A843)),
                                            ):Text(
                                                'Select OBECM ',
                                ...
                                if (widget.ev_technology.contains("PHEV") ==
                                  ...
                                  if (form.validate()) {
                                    ...
                                    sodoservice
                                        ...
                                        double.parse(widget.obfcm.toString()),
                                        widget.vehicleId,
                                  ...
                                  print('You are moving to ODOMETER FROM OBCEM USING PHEV');
                                  Navigator.pushReplacement(
                                      context, MaterialPageRoute(builder: (context) {
                                    return OdometerPicture(vehicleId:widget.vehicleId, issoda: true,ev_technology: widget.ev_technology, checkMileage: false,isphev: true, mileage: widget.mileage,obcem:mileage,);
                                  }));
